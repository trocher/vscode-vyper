...
const BUILTINS = {
    ...
    "gas": {
        "prefix": "msg.gas",
        "description": "gas() returns (uint256): remaining gas",
    },
    "msg": {
        "prefix": "msg",
        "description": "msg",
    ...
    "abi_decode": {
        "prefix": "abi_decode",
        "description": "abi.decode(encoded_data: Bytes[N]) returns (...): ABI-decodes the given data, while the types are given in parentheses as second argument.",
        "security":""
    },
    "abi_encode": {
        "prefix": "abi_encode",
        "description": "abi.encode(...) returns (Bytes[N]): ABI-encodes the given arguments",
        "security":""
    },
    "assert": {
        "prefix": "assert",
        "description": ["assert test, [msg]:\n\tabort execution and revert state changes if the condition is not met","assert test, UNREACHABLE:\n\tabort execution with an invalid opcode if the condition is met, all gas is consumed"],
        "security":""
    },
    "raise": {
        "prefix": "raise",
        "description": ["raise:\n\tabort execution and revert state changes","raise msg:\n\tabort execution and revert state changes, providing an explanatory string","raise UNREACHABLE:\n\tabort execution with an invalid opcode, all gas is consumed"],
        "security":""
    },
    "addmod": {
        "prefix": "addmod",
        "description": "addmod(x: uint256, y: uint256, k: uint256) returns (uint):\n\tcompute (x + y) % k where the addition is performed with arbitrary precision and does not wrap around at 2**256.",
        "security":""
    },
    "mulmod": {
        "prefix": "mulmod",
        "description": "mulmod(x: uint256, y: uint256, k: uint256) returns (uint):\n\tcompute (x * y) % k where the multiplication is performed with arbitrary precision and does not wrap around at 2**256.",
        "security":""
    },
    "keccak256": {
        "prefix": "keccak256",
        "description": "keccak256(Bytes[N]) returns (bytes32):\n\tcompute the Keccak-256 hash of the input",
        "security":""
    },
    "sha256": {
        "prefix": "sha256",
        "description": "sha256(Bytes[N]) returns (bytes32):\n\tcompute the SHA-256 hash of the input",
    },
    "ecrecover": {
        "prefix": "ecrecover",
        "description": "ecrecover(hash, v, r, s) returns (address):\n\trecover the address associated with the public key from elliptic curve signature or return zero on error (example usage)",
    },
    "_balance": {
        "prefix": ".balance",
